...
class LLMService:
    ...
    def _initialize_client(self):
        ...
        if settings.LLM_PROVIDER == "azure_openai":
            ...
            return None
    async def analyze_flights(self, flights_data: List[Dict], context: Dict = None) -> Dict[str, Any]:
        """항공편 데이터 분석"""
        try:
            if not self.client:
            ...
            for flight in flights_data:
                efficiency_result = await self.calculate_efficiency_score(flight, context)
    ...
    async def calculate_efficiency_score(self, flight_data: Dict, context: Dict = None) -> Dict[str, Any]:
        """항공편의 효율성 점수 계산"""
